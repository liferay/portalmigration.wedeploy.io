...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fhrFW", function() { return fhrFW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace fhrFW.
 * @public
 */

goog.module('fhrFW.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param205 = function() {
    ie_open('article', null, null,
      ...
      ie_open('ul');
        ie_open('li');
          itext('AUI.$ returns a jQuery nodeList with many methods available. Replacing it with ');
          ie_open('code');
            itext('document.querySelector');
          ie_close('code');
          itext(' or ');
          ie_open('code');
            itext('document.querySelectorAll');
          ie_close('code');
          itext(' we lose all that methods.');
        ie_close('li');
      ie_close('ul');
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('ul');
        ...
        ie_open('li');
          ...
          ie_open('ul');
            ie_open('li');
              ie_open('p');
                itext('Note: Some methods can\'t be directly replaced with native implementations so we may need to use some utilities from metal like ');
                ie_open('code');
                  itext('metal-dom');
                ie_close('code');
                itext('. To do it we need to import the module in the jsp in the following way:');
              ie_close('p');
              $templateAlias2({code: '<aui:script require="metal-dom/src/dom">\n  let dom = metalDomSrcDom.default;\n  ...\n</aui:script>', mode: 'text'}, null, opt_ijData);
              ie_open('p');
                itext('or');
              ie_close('p');
            ...
            ie_open('li');
              ie_open('p');
                ...
                itext(' with');
              ie_close('p');
              $templateAlias2({code: 'fetch(url, {\n  body: new FormData(form),\n  credentials: \'include\',\n  method: \'POST\',\n  ...\n})\n.then(response => ...);', mode: 'text'}, null, opt_ijData);
            ie_close('li');
            ie_open('li');
              ie_open('p');
                itext('Replace ');
            ...
            ie_open('li');
              ie_open('p');
                ...
                itext(' with');
              ie_close('p');
              $templateAlias2({code: '  form\n  dom.exitDocument(element)', mode: 'text'}, null, opt_ijData);
            ie_close('li');
            ie_open('li');
              ie_open('p');
                itext('Replace ');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'fhrFW.render';
}
...
class fhrFW extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(fhrFW, templates);
...
var _aui$Soy = __webpack_require__(96);

var _aui$Soy2 = _interopRequireDefault(_aui$Soy);
...
var fhrFW = function (_Component) {
  _inherits(fhrFW, _Component);

  function fhrFW() {
    _classCallCheck(this, fhrFW);

    return _possibleConstructorReturn(this, (fhrFW.__proto__ || Object.getPrototypeOf(fhrFW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fhrFW, _aui$Soy2.default);

exports.default = fhrFW;
