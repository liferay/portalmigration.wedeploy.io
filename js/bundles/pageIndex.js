var pageComponent =
webpackJsonppageComponent([7,8,9],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ...
  $templateAlias1(soy.$$assignDefaults({content: param61, elementClasses: 'home'}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('small', null, null,
              'class', 'ml-1');
            var dyn5 = opt_data.site.subtitle;
            if (typeof dyn5 == 'function') dyn5(); else if (dyn5 != null) itext(dyn5);
          ie_close('small');
        ie_close('div');
        ie_open('ul', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('p', null, null,
              ...
              ie_open('a', null, null,
                  'class', 'font-weight-bold',
                  'href', 'https://github.com/carloslancha/metal-clay-portal-migration',
                  'target', '_blank');
                itext('GitHub repo.');
              ie_close('a');
            ie_close('p');
...
exports.header.params = ["page","site"];
exports.header.types = {"page":"any","site":"any"};
