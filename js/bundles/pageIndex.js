var pageComponent =
webpackJsonppageComponent([3,4,5],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ...
  $templateAlias1(soy.$$assignDefaults({content: param161, elementClasses: 'home'}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('small', null, null,
              'class', 'ml-1');
            var dyn18 = opt_data.site.subtitle;
